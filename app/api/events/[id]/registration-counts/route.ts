...
// GET /api/events/[id]/registration-counts
// Returns { [shiftId]: count } for all shifts on an event.
// Accessible to org admins AND active event admins.
export async function GET(_req: NextRequest, { params }: Params) {
  ...
  if (shiftIds.length === 0) return NextResponse.json({});
